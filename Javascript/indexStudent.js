...
function confirmNewUpdate() {
  ...
  const inputLastNameWizardUpdate = document.querySelector(
    "#lastNameWizardUpdate"
  );
  const inputEmailWizardUpdate = document.querySelector("#emailWizardUpdate");
  const inputFirstCalificationUpdate = document.querySelector(
    "#calification-1st-update"
  );
  const inputSecondCalificationUpdate = document.querySelector(
    "#calification-2nd-update"
  );
  const inputThirdCalificationUpdate = document.querySelector(
    "#calification-3rd-update"
  );
  ...
  fetch(
    `./updateWizard.php?studentId=${idUpdate}&nameWizardUpdate=${name}&lastNameWizardUpdate=${lastName}&emailWizardUpdate=${email}&firstCalificationUpdate=${firstCalification}&secondCalificationUpdate=${secondCalification}&thirdCalificationUpdate=${thirdCalification}`,
    {
      method: "GET",
    }
  )
    ...
    .then((data) => {
      if (data.ok) {
        ...
        const lastNameWizardValue = document.querySelector(
          `#lastName-${idUpdate}`
        );
        const emailWizardValue = document.querySelector(`#email-${idUpdate}`);
        const firstTrimesterValue = document.querySelector(
          `#firstTrimester-${idUpdate}`
        );
        const secondTrimesterValue = document.querySelector(
          `#secondTrimester-${idUpdate}`
        );
        const thirdTrimesterValue = document.querySelector(
          `#thirdTrimester-${idUpdate}`
        );
...
function goToFirstTrimester() {
  ...
  if (
    calificationsGlobalFirst.classList.contains("mark-calification-notShow")
  ) {
    calificationsGlobalFirst.classList.replace(
      "mark-calification-notShow",
      "mark-calification"
    );
  }

  if (
    calificationsGlobalSecond.classList.contains("mark-calification-2-show")
  ) {
    calificationsGlobalSecond.classList.replace(
      "mark-calification-2-show",
      "mark-calification-2"
    );
  }

  if (calificationsGlobalThird.classList.contains("mark-calification-3-show")) {
    calificationsGlobalThird.classList.replace(
      "mark-calification-3-show",
      "mark-calification-3"
    );
  }
}
...
function createNewWizard() {
  ...
  fetch(
    `./createWizard.php?nameWizard=${name}&lastNameWizard=${lastName}&emailWizard=${email}&firstCalification=${firstCalification}&secondCalification=${secondCalification}&thirdCalification=${thirdCalification}`,
    {
      method: "GET",
    }
  )
  ...
  if (teacherAreaCalifications.classList.contains("modal-creation-show")) {
    teacherAreaCalifications.classList.replace(
      "modal-creation-show",
      "modal-creation"
    );
  }
